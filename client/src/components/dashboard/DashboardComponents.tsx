  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {trigger || <Button>Create Department</Button>}
      </DialogTrigger>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              id="dept-name"
              placeholder="e.g., Water Supply & Sanitation"
              value={name}
          ...
          <div className="border-t pt-4">
            <p className="text-sm font-semibold text-gray-700 mb-3">Authorized Contact Person</p>
...
export const AddOfficerDialog: React.FC<{
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {trigger || <Button>Add {roleTitle}</Button>}
      </DialogTrigger>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeader>
